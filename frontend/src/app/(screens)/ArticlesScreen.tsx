...
const articles = [
  {
    ...
    url: 'https://www.example.com/anxiety-article.pdf',
  },
  {
    id: '2',
    title: 'Mindfulness Techniques',
    description: 'Explore practical mindfulness exercises to improve your mental well-being.',
    image: 'https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=400&q=80',
    gradient: ['#43e97b', '#38f9d7'],
    url: 'https://www.example.com/mindfulness-article.pdf',
  },
  {
    id: '3',
    title: 'Building Resilience',
    description: 'Tips and strategies to help you build emotional resilience in daily life.',
    image: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=400&q=80',
    gradient: ['#fa709a', '#fee140'],
    url: 'https://www.example.com/resilience-article.pdf',
  },
];
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.headerDescription}>Read and download insightful articles on mental wellness and coping strategies.</Text>
        </View>
      </View>
      <FlatList
        data={articles}
